...
export default class extends React.Component {
    ...
    finishRecordFootprint(SetDrawRelease) {
        this.clearWatch(this.watchId);
        this.upLoadTrace(SetDrawRelease);
    ...
    render() {
        ...
        const [draw_release, setDraw_release] = React.useState(false);
        return draw_release ? <ReleaseScreen setDrawRelease={setDraw_release}/> : (
            <View style={style.body}>
                ...
                <ActionButton position={'center'} offsetY={40} size={85} renderIcon={() => (isRecordingFootprint ?
                    ...
                    this.handleRecordFootprintBtnClicked(setDraw_release)
                }}>
