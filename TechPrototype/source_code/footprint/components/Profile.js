...
const Profile=()=>{
    ...
    <VStack space={2}>
        <HStack justifyContent="space-around" mt="20%" mr={0.1 * w}>
            ...
            }} alt="Aang flying and surrounded by clouds" rounded="full" size={0.2 * w} />
            <Box justifyContent="space-around" ml= {-0.1 * w}>
                <VStack space={2} >
         ...
         <HStack justifyContent="space-around" mt={0.05 * w}>
            <HStack width={w * 0.5}  height={0.2 * w} flexDirection="row" ml="0">
